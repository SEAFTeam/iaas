...
tenant = cloudproject
projectName = cloudproject #заменить на название проекта из лк cloud.ru
########### Выберем услуги

serversExport = False                         # Elastic Cloud Server
eipExport = False                             # Elastic IP (external ip addresses)
vaultExport = False                           # Cloud Backup and Recovery vaults
backup_policyExport = False                   # Cloud Backup and Recovery policies
rdsExport = False                             # Relational Database Service                     
natgatewayExport = False                      # NAT Gateway
elbExport = False                             # Elastic Load Balance
cceExport = True                              # Cloud Container Engine
dmsExport = False                             # Distributed Message Server

#############       Must        #############
secgroupsExport = True                        # Security Groups
vpcsExport = True                            # VPC
subnetsExport = True                         # Subnets 
peerExport = True                            # VPC peerings
#############   End of Must     #############
...
if dmsExport == True:
    try:
        print(f'    Processing tenant: {projectName} DMS')
        ...
        with open('exports/dmss.yaml', 'w', encoding='utf-8') as outfile:
            ...
            print(f'Error in tenant: {projectName} with dmss')

#########    End of Distributed Message Services Section   #########

#########     Security Groups Export    #########
if secgroupsExport == True:
    try:
        print(f'    Processing tenant: {projectName} secgroups')
        ...
        print(f'Error in tenant: {projectName} with security_groups')
#########    End of Security Groups Section   #########

#########     Cloud Container Engines Export    #########
if cceExport == True:
    try:
        print(f'    Processing tenant: {projectName} CCE')
        ...
        with open('exports/cces.yaml', 'w', encoding='utf-8') as outfile:
            ...
            print(f'Error in tenant: {projectName} with cces')
#########    End of Cloud Container Engines Section   #########

#########     NAT Gateway Export    #########
if natgatewayExport == True:
    try:
        print(f'    Processing tenant: {projectName} NatGateways')
        ...
        print(f'Error in tenant: {projectName} with nat_gateways')
...
if elbExport == True:
    try:
        print(f'    Processing tenant: {projectName} ELBs')
        ...
        print(f'Error in tenant: {projectName} with elbs')
######### End of Elastic Load Balance Section ###########

######### Servers Export #########
if serversExport == True:
    try:
        print(f'    Processing tenant: {projectName} Servers')
        ...
        print(f'Error in tenant: {projectName} with ecss')
####### End of Servers Export ########

######### Export VPCS #########
if vpcsExport == True:
    try:
        print(f'    Processing tenant: {projectName} VPCs')
        ...
        print(f'Error in tenant: {projectName} with vpcs')
######### End of VPCS export #########

######### Subnets Export #########
if subnetsExport == True:
    try:
        print(f'    Processing tenant: {projectName} subnets')
        ...
        print(f'Error in tenant: {projectName} with subnets')
######### End of Subnets export #########

######### VPC Peers Export #########
if peerExport == True:
    try:
        print(f'    Processing tenant: {projectName} Peerings')
        ...
        print(f'Error in tenant: {projectName} with peerings')
######### End of VPC Peers export #########

######### Elastic IPs Export #########
if eipExport == True:
    try:
        print(f'    Processing tenant: {projectName} EIPS')
        eips = get_scloud(service='eip', s_type=None, region=cloudregion, project=cloudproject, item=None)
        ...
        print(f'Error in tenant: {projectName} with eips')
######### End of Elastic IPs export #########

######### Backup Vaults Export #########
if vaultExport == True:
    try:
        print(f'    Processing tenant: {projectName} Vaults')
        ...
        print(f'Error in tenant: {projectName} with vaults')
######### End of Backup Vaults export #########

######### Backup policy Export #########
if backup_policyExport == True:
    try:
        print(f'    Processing tenant: {projectName} BackUpPolicies')
        ...
        print(f'Error in tenant: {projectName} with backup_policies')
######### End of Backup Policies export #########

######### Relational Dtabase as a Service Export #########
if rdsExport == True:
    try:
        print(f'    Processing tenant: {projectName} RDS')
        ...
        print(f'Error in tenant: {projectName} with rdss')
